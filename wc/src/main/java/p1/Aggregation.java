...
public class Aggregation
{
	public static void main(String[] args) throws Exception 
	{
		...
		DataStream<String> data = env.readTextFile("/mnt/flink/flinkworkspace/dataset/avg1");
		...
		mapped.keyBy(0).sum(3).writeAsText("/mnt/flink/flinkworkspace/outputs/out1");

		mapped.keyBy(0).min(3).writeAsText("/mnt/flink/flinkworkspace/outputs/out2");
		
	   	mapped.keyBy(0).minBy(3).writeAsText("/mnt/flink/flinkworkspace/outputs/out3");
		
		mapped.keyBy(0).max(3).writeAsText("/mnt/flink/flinkworkspace/outputs/out4");
		
		mapped.keyBy(0).maxBy(3).writeAsText("/mnt/flink/flinkworkspace/outputs/out5");
		// execute program
