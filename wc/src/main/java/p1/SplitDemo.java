...
public class SplitDemo 
{
     public static void main(String[] args) throws Exception
 {
	...
	DataStream<String> text = env.readTextFile("/mnt/flink/flinkworkspace/dataset/oddeven");
	...
	evenData.writeAsText("/mnt/flink/flinkworkspace/outputs/even");
	oddData.writeAsText("/mnt/flink/flinkworkspace/outputs/odd");
